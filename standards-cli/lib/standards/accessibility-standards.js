...
const AccessibilityStandards = {
  ...
  contrast: {
    ...
    textOnBackground: {
      normalText: {
        ...
        description:
          'Minimum contrast ratio for normal text (14pt+) on any background',
      },
      largeText: {
      ...
      uiElements: {
        ...
        description:
          'Minimum contrast ratio for interactive elements, borders, and icons',
      },
    },
    ...
    avoidCombinations: [
      {
        text: '#6b7280',
        background: '#ffffff',
        reason: 'Gray-500 on white fails WCAG AA (3.1:1)',
      },
      {
        text: '#9ca3af',
        background: '#ffffff',
        reason: 'Gray-400 on white fails WCAG AA (2.3:1)',
      },
      {
        text: '#d1d5db',
        background: '#ffffff',
        reason: 'Gray-300 on white fails WCAG AA (1.6:1)',
      },
      {
        text: '#374151',
        background: '#f3f4f6',
        reason: 'Gray-700 on gray-100 may be borderline (3.8:1)',
      },
    ],
  ...
  typography: {
    ...
    fonts: {
      readability: {
        ...
        fallbacks:
          'Always include generic fallbacks (sans-serif, serif, monospace)',
      },
    },
  },
  ...
  interactivity: {
    ...
    clickTargets: {
      ...
      description:
        'Ensure all clickable elements are large enough and well-spaced',
    },
    ...
    stateIndicators: {
      ...
      disabledStates: {
        ...
        contrastRatio:
          'Disabled text should still meet 3:1 ratio where possible',
      },
    },
  },
  ...
  components: {
    cards: {
      textHierarchy: {
        ...
        muted:
          'Use gray-500 (#6b7280) sparingly and only for truly auxiliary information',
    ...
    navigation: {
      activeStates: {
        ...
        differentiation:
          'Use multiple visual cues: color, background, font-weight',
  ...
  testing: {
    ...
    manual: {
      ...
      contrastCheckers:
        'Use tools like WebAIM Contrast Checker, Colour Contrast Analyser',
    },
  },
  ...
  commonIssues: {
    lowContrastText: {
      ...
      impact:
        'Affects users with low vision, older users, users in bright environments',
    },
