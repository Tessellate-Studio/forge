...
```javascript
const rubric = require('@tessellate-studio/rubric-sdk');
...
Works alongside `@tessellate-studio/code-directives` for complete project management:
...
- **Package Name**: `@tessellate-studio/rubric-sdk`
...
```javascript
const { RubricEngine, ReportGenerator } = require('@tessellate-studio/rubric-sdk');
  ...
  evaluate:
    ...
    steps:
      ...
      - name: Install Rubric SDK
        run: npm install -g @tessellate-studio/rubric-sdk
